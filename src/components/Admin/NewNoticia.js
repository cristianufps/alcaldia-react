                    ...
                    <Col xs="6">
                        ...
                        <Form onSubmit={this.enviarDatos} name="formulario">
                            <FormGroup className="form_group">
                                ...
                                <Input type="text" id="nombre" name="titulo" onChange={this.param}></Input>
                            </FormGroup>
                            <FormGroup className="form_group">
                                <Label id="label"><strong>Descripcion</strong></Label>
                                <Input type="textarea" id="descripcion" name="descripcion" onChange={this.param}></Input>
                            </FormGroup>
                            <FormGroup className="form_group">
                                <Label id="label"><strong>Fecha</strong></Label>
                                <Input type="date" id="fechaCreacion" name="fecha" onChange={this.param}></Input>
                            </FormGroup>
                            <FormGroup className="form_group">
                                <Label className="image"><strong>Imagen</strong></Label>
                                <Input type="file" id="imagen" accept="image/*" name="files" onChange={this.imagen}></Input>
                            </FormGroup>
                            <FormGroup className="form_group">
